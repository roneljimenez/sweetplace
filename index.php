...
<body>
                    ...
                    <div class="col-md-8 col-xl-4 col-12">
                        ...
                        <form id="formulario-contacto" method="POST" action="sendform.php">
                            ...
                            <div class="form-group">
                                ...
                                <label for="exampleFormControlTextarea1">Producto o Servicio que deseas cotizar</label>
    ...
    <section class="adn mb-4" data-aos="fade-right" data-aos-delay="50">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5 class="section-title text-center">Cajas de <strong>Regalo personalizadas</strong></h5>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-6">
                    <img class="d-block w-100" src="images/sweetplace-producto-cajas-7-min.jpg" alt="">
                </div>
                <div class="col-12 col-md-6 d-flex align-items-center flex-column justify-content-center">
                    <p class="adn-description">Caja sorpresa con Taza o Vaso personalizado.<br>
                    <small>Incluye Maní, cabritas, galletitas saladas y bebida / cerveza / energética.</small>
                    </p>
    ...
    <section class="adn mb-4" data-aos="fade-left" data-aos-delay="50">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5 class="section-title text-center">Tazas con <strong>diseño único</strong></h5>
                </div>
            </div>
            <div class="row">
    ...
    <section class="products mb-5" data-aos="fade-left" data-aos-delay="50">
        <div class="container">
             <div class="row">
                <div class="col-12">
                    <h5 class="section-title text-center">Sorprende con nuestras opciones <strong>Románticas</strong></h5>
                </div>
            </div>
            <div class="row">
    ...
    <section class="decoraciones mb-4
    ">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="images/babyshower-ethan-2-min.jpg" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="images/cumple-iveth-19-min.jpg" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="images/DSC04546-Editar-min.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="images/DSC02284edit-min.jpg" alt="Third slide">
                          </div>
                        </div>
